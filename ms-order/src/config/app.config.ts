...
export class EnvironmentVariables {
    static get PORT(): number {
        return process.env.PORT || env.PORT || 3100;
    }
    ...
    static get MONGO_DATABASE_NAME(): string {
        return process.env.MONGO_DATABASE_NAME || env.DATABASE.MONGO.NAME || "order";
    }
    ...
    static get MONGO_PORT(): number {
        return process.env.MONGO_PORT || env.DATABASE.MONGO.PORT || 27018;
    }
